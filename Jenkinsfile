node {
    ...
    stage('Upload artifactory - Nexus 3') {
        node ('master') {
            ...
            archiveArtifacts artifacts: 'timeoff-management@2.zip', fingerprint: true
            sh "cd /var/lib/jenkins/workspace/timeoff-management@2;curl -v -u admin:sILVANa1996!+ --upload-file timeoff-management@2.zip http://192.168.0.107:8081/repository/timeoffmanagement/timeoff-management@2.zip"

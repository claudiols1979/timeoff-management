node {
    ...
    stage('SonarQube Analysis') {
        node ('master') {
              sh "/opt/sonar-scanner/bin/sonar-scanner sonar.login=admin sonar.password=sILVANa1996!+ -Dsonar.host.url=http://192.168.0.107:9000 -Dsonar.projectName=timeoff-management -Dsonar.projectVersion=1.0 -Dsonar.projectKey=timeoff-management:app -Dsonar.sources=. -Dsonar.projectBaseDir=/var/lib/jenkins/workspace/timeoff-management@2"
            }                       
    }
